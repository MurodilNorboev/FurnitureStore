...
// import { Catalog_con, Image, ImageContainer, ImageGrid, Imagecontent, PagesName, Saidbar, SlaiderContainer } from '../3catalog.page/catalog';
...
// export default function MenusComponent( Props: Tname ) {
...
//   const displayeddata = data ? data.slice(startIdx, endIdx) : [];
