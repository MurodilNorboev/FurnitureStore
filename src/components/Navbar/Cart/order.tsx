...
const OrderComponent = (Props: Tname) => {
  return (
    <div>
        ...
        <h3>Home</h3><img src={home} alt="img" /><h3>Checkout</h3><img src={home} alt="img" /><h4>{Props.name}</h4> 
        </PagesName>
      ...
      <ErrorContent>
        ...
        <ErrorCon>
          <ErrorMidl>
            <h5>id 4567</h5>
            <h2>Thank you! Your order <br /> has placed succesfully</h2>
            <p>An order confirmation email has been sent to your e-mail address <br /> alexinfo@gmail.com. Expect further messages</p>
            <Navlink to={'/'}>
              <BtnWrap4>
                <div className='wrapper'>
                  <button>check mailbox<img src={circle} alt="" /></button>
                </div>
              </BtnWrap4>
            </Navlink>
          </ErrorMidl>
